...
class _SaveDocumentPageState extends State<SaveDocumentPage> {
  ...
  final List<String> categoires = ['Kartu', 'Nota', 'Surat'];
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Save Dokument"),
      ),
      body: ListView(
        padding: const EdgeInsets.all(16.0),
        children: [
          // Icon(Icons.description,size: 80,color: AppColors.primary,),
          SizedBox(
      ...
      bottomNavigationBar: InkWell(
        onTap: (){
          ...
          DocumentModel model = DocumentModel(
            ...
            // DateFormat perlu depedesis intl 
